...
package org.hackthelegacy.hack400tool.auditor;
...
import org.hackthelegacy.hack400tool.core.IBMiAuditor;

public class App extends javax.swing.JFrame {

	private static final long serialVersionUID = -9001238657861164520L;
	...
	private void initComponents() {
		...
		jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/hack400auditor.png"))); // NOI18N
		...
		jLabel5.setText(
				"<html>This program is DEMO only. By using the Scan button, the tool will connect to the system, gather basic information (system values, open ports, etc.), compare these against established security best practices and generate a PDF report.<br><br>A full (commercial) version is in development.</html>");
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
						...
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(158, 158, 158)
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
										.addComponent(jLabel4).addComponent(scanButton))
						...
						.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout
								...
								.addGroup(jPanel1Layout.createSequentialGroup().addGap(10, 10, 10)
										.addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 517,
						...
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
								...
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										...
										.addComponent(systemField, javax.swing.GroupLayout.PREFERRED_SIZE, 114,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(usernameField, javax.swing.GroupLayout.PREFERRED_SIZE, 114,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(passwordField, javax.swing.GroupLayout.PREFERRED_SIZE, 114,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addGap(162, 162, 162)))
						.addContainerGap()));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(systemField, javax.swing.GroupLayout.PREFERRED_SIZE,
						...
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(useSSLCheckbox)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(scanButton)
			...
			protected Void doInBackground() throws Exception {
				try {
					...
					testSystem = new IBMiAuditor(systemField.getText(), useSSLCheckbox.isSelected(), false, "QTEMP",
							usernameField.getText(), passwordField.getPassword(), getClass().getName());
					appendToTextPane(statusTextPane, "connected. \n", Color.GREEN);
					appendToTextPane(statusTextPane, "2/4 Checking system values... ", Color.BLUE);
					Logger.getLogger(getClass().getName()).log(Level.INFO, "checkSystemValues");
					...
					Logger.getLogger(getClass().getName()).log(Level.INFO, "checkInsecurePorts");
					...
					parameters.put("AuditorLogo", ImageIO.read(getClass().getResource("/images/hack400auditor.png")));
					Class.forName("org.sqlite.JDBC");
					Connection dbConnection = DriverManager
							.getConnection("jdbc:sqlite:" + testSystem.getReportDBName());

					JasperPrint jasperPrint = JasperFillManager.fillReport(
							getClass().getResourceAsStream("/reports/IBMiAuditReport.jasper"), parameters,
							dbConnection);
					String filename = "reports" + File.separator + systemField.getText() + " - "
