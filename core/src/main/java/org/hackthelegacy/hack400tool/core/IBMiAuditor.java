...
public class IBMiAuditor extends IBMiConnector {
    ...
    public IBMiAuditor(String serverAddress, boolean useSSL, boolean useJDBC, 
                        String temporaryLibrary, String userName, char[] password, String uiClassName) 
        ...
        File dbFile = new File("db/IBMiAuditor.db");
        dbFile.createNewFile();
        
        settingsDB = new SqliteDbConnector("db/IBMiAuditor.db");
