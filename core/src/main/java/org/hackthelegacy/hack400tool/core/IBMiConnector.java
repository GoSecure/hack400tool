...
public class IBMiConnector {
    ...
    public IBMiConnector(String serverAddress, boolean useSSL, boolean useJDBC, boolean useGUI, boolean useSockets, boolean useNetSockets, String temporaryLibrary, String userName, char[] password, boolean useProxy, String proxyServer, String uiClassName) 
        ...
        try {
            ...
            JDBCConnection = DriverManager.getConnection ("jdbc:as400://" + serverAddress, userName, String.valueOf(password));
    ...
    public IBMiConnector(String serverAddress, boolean useSSL, boolean useJDBC, boolean useGUI, boolean useSockets, boolean useNetSockets, String temporaryLibrary, String userName, char[] password) 
            throws AS400SecurityException, IOException, 
            ErrorCompletingRequestException, InterruptedException, 
            PropertyVetoException, ObjectDoesNotExistException, SQLException, KeyManagementException, NoSuchAlgorithmException{
        this(serverAddress, useSSL, useJDBC, useGUI, useSockets, useNetSockets, temporaryLibrary, userName, password, false, "", null);
    }
    
    public IBMiConnector(String serverAddress, boolean useSSL, boolean useJDBC, String temporaryLibrary, String userName, char[] password)
            throws AS400SecurityException, IOException, 
            ErrorCompletingRequestException, InterruptedException, 
            PropertyVetoException, ObjectDoesNotExistException, SQLException, KeyManagementException, NoSuchAlgorithmException{
    ...
    public IBMiConnector(String serverAddress, boolean useSSL, String temporaryLibrary, String userName, char[] password)
            throws AS400SecurityException, IOException, 
            ErrorCompletingRequestException, InterruptedException, 
            PropertyVetoException, ObjectDoesNotExistException, SQLException, KeyManagementException, NoSuchAlgorithmException{
    ...
    public IBMiConnector(String serverAddress, String userName, char[] password) 
            throws AS400SecurityException, IOException, 
            ErrorCompletingRequestException, InterruptedException, 
            PropertyVetoException, ObjectDoesNotExistException, SQLException, KeyManagementException, NoSuchAlgorithmException{
    ...
    public DefaultListModel<UserInfo> getUsersHashes(ListModel<String> users) throws PropertyVetoException, AS400SecurityException, ErrorCompletingRequestException, IOException, InterruptedException, ObjectDoesNotExistException {
        while (isActiveTask)
            Thread.sleep(1);
    	...
    	for(int i = 0; i< users.getSize();i++){
            ...
            if (hashString == null) {
            	Logger.getLogger(this.uiClassName).log(Level.SEVERE, "Could not retrieve hashes. Insufficient privileges?");
                return null;
            }
