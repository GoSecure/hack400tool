...
import org.hackthelegacy.hack400tool.core.IBMiConnector;
        ...
        final SwingWorker<Void, Void> mySwingWorker = new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                try{
                    ...
                    JasperPrint jasperPrint = JasperFillManager.fillReport(getClass().getResourceAsStream("/reports/IBMiAuditReport.jasper"),
                        parameters, dbConnection);
                    String filename = "reports" + File.separator + systemField.getText() + " - " + new SimpleDateFormat("YYMMddHHmmSS").format(new Date()) + ".pdf";
