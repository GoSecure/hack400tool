...
public class App extends javax.swing.JFrame {
    ...
    public App() throws IOException {
        ...
        File dbFile = new File("db/IBMiScanner.db");
        dbFile.createNewFile();
        
        dbConnection = new SqliteDbConnector("db/IBMiScanner.db");
    ...
    private void initComponents() {
        ...
        deselectAllButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Unchecked Checkbox_20px.png"))); // NOI18N
    ...
    private void connectButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connectButtonActionPerformed
                ...
                try {
                    ...
                    if (useProxy.isSelected()) {
                        testSystem = new IBMiConnector(systemName.getText(), useSSL.isSelected(), useJDBC.isSelected(), 
                            ...
                            passwordField.getPassword(), true, proxyTextField.getText(), getClass().getName());
                    }
                    else {            
                        testSystem = new IBMiConnector(systemName.getText(), useSSL.isSelected(), useJDBC.isSelected(), 
                                useGUI.isSelected(), useSockets.isSelected(), useNetSockets.isSelected(),
        ...
        if (IBMiConnector.SYSTEM_LIBRARIES.contains(temporaryLibTextField.getText().toUpperCase())) {
        	Logger.getLogger(getClass().getName()).log(Level.SEVERE, null, String.format("Cannot use system library %s as temporary library.", temporaryLibTextField.getText().toLowerCase()));
        } else {
                                ...
                                for (int selectedRow : settingsTable.getSelectedRows()) {
                                    ...
                                    if (detailSettings.getRowCount() < 1) {
                                        ...
                                        switch (((String)detailSettings.getValueAt(0, 0)).toUpperCase()) /*function_type*/ {
                                            case "CLCMD":
                                                Logger.getLogger(getClass().getName()).log(Level.INFO, "Running command " + (String)detailSettings.getValueAt(0, 1));
                                                ...
                                                break;
                                                case "METHOD":
                                                    Logger.getLogger(getClass().getName()).log(Level.INFO, "Running method " + (String)detailSettings.getValueAt(0, 1));
                                                ...
                                                Logger.getLogger(getClass().getName()).log(Level.INFO, "Test finished. Check directory "
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            escalateToComboBox.setModel(new DefaultComboBoxModel<String>(Arrays.stream(testSystem.getEscalationUsers().toArray()).toArray(String[]::new)));
        } catch (Exception ex) {
            Logger.getLogger(getClass().getName()).log(Level.SEVERE, null, ex);
        }
